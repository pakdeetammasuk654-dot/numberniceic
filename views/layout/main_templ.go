...
func Main(seo SEOProps, isLoggedIn bool, isAdmin bool, isVIP bool, hasShippingAddress bool, activePage string, toastSuccess string, toastError string, avatarURL string, content templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "\"><!-- Global Upgrade Modal Container --><div id=\"upgrade-modal-container\" class=\"modal-overlay\" style=\"display: none; z-index: 9999;\"><!-- HTMX will inject content here --></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.Navbar(isLoggedIn, isAdmin, isVIP, hasShippingAddress, activePage, avatarURL).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
